...
\begin{center}
	\huge {\bfseries \textcolor{black}{{Introduction to R Programming Lab}}} \par
	\vspace{0.5\baselineskip}
	{\LARGE \bf \textcolor{black}{(BTCCSPCP501)} \par}
	\vspace{1.5\baselineskip}
	{\Large An Assignment Work Submitted for the 5th Semester \\ of Bachelor of Technology } \par
