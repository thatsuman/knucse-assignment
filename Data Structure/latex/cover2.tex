%%%%%%%%%%%%%%%%%%%%%%55 If you want to use this cover separately // Template %%%%%%%%%%%
...
% \begin{center}
% 	\huge {\bfseries \textcolor{black}{{KNU Organizer on DSA}}} \par
% 	\vspace{1.2\baselineskip}
% 	{\Large A collaborative work of students of 3rd Semester \\ of Bachelor of Technology } \par
% 	\vspace{1\baselineskip}
% 	{\Large \textit{in} \par}
% 	\vspace{1\baselineskip}
% 	{\LARGE \bf \textcolor{black}{Computer Science and Engineering (Data Science)} \par} 
% 	\vspace{1\baselineskip}
% 	{\Large \textit{prepared by} \par}
% 	\vspace{1\baselineskip}
...
% 	\normalsize Copyright \textcopyright \:2022 Kazi Nazrul University \\ All rights reserved.
% \end{center}