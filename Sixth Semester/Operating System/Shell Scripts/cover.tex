...
\begin{center}
	\huge {\bfseries \textcolor{black}{{Operating System Lab}}} \par
	\vspace{0.5\baselineskip}
	{\LARGE \bf \textcolor{black}{(BTCCSPCC602)} \par}
	\vspace{1.5\baselineskip}
	{\Large An Assignment Work Submitted for the 6th Semester \\ of Bachelor of Technology } \par
