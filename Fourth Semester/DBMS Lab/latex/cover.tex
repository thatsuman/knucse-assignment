...
\begin{center}
	\huge {\bfseries \textcolor{black}{{Database Management System Lab}}} \par
	\vspace{1.5\baselineskip}
	{\Large An Assignment Work Submitted for the 4th Semester \\ of Bachelor of Technology } \par
	...
	{\Large \textit{by} \par}
	\vspace{1\baselineskip}
	{{\LARGE {\bf \textcolor{black}{Suman Mondal} \\ \vspace{1\baselineskip} Registration Number: 100227240046}} \par}
	\vspace{1.5\baselineskip}
	{\begin{figure}[!h] 
			\centering
